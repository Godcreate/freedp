...
class Client(BaseClient):
    ...
    def futures_change_position_mode(self, **params):
        ...
        :param dualSidePosition: required, Set Dual Side Position
        :type dualSidePosition: bool
        :param recvWindow: the number of milliseconds the request is valid for
        :type recvWindow: int
        :returns: API response
    ...
    def futures_change_multi_assets_mode(self, multiAssetsMargin: bool):
        ...
        :param multiAssetsMargin: required, Set Multi-Assets Mode
        :type multiAssetsMargin: bool
        :returns: API response
    ...
    def futures_stream_get_listen_key(self):
        ...
        .. code-block:: python
            ...
            {
                "listenKey": "pqia91ma19a5s61cv6a81va65sdf19v8a65a1a3xz26a81z2761ab121a"
            }
    ...
    def futures_stream_keepalive(self, listenKey):
        ...
        :param listenKey: required, The listenKey from the stream
        :type listenKey: str
        :returns: API response
    ...
    def futures_coin_continous_klines(self, **params):
        ...
        :param pair: required, Symbol
        :type pair: str
        :param contractType: required, Contract type
    ...
    def futures_coin_mark_price(self, **params):
        ...
        .. code-block:: python
            ...
            {
                "symbol": "BTCUSD_PERP",
                "markPrice": "11123.45678912",
                "indexPrice": "11123.45678912",
                "estimatedSettlePrice": "11123.45678912",
                "lastFundingRate": "0.00156432",
                "interestRate": "0.00012345",
                "nextFundingTime": 1564024800000,
                "time": 1564024731065
            }
    ...
    def futures_coin_funding_rate(self, **params):
        ...
        .. code-block:: python
            ...
            [
                {
                    "symbol": "BTCUSD_PERP",
                    "fundingRate": "0.00156432",
                    "fundingTime": 1564024800000
                },
                {
                    "symbol": "BTCUSD_PERP",
                    "fundingRate": "0.00156432",
    ...
    def futures_coin_ticker(self, **params):
        ...
        .. code-block:: python

            {
                ...
                "lowPrice": "0.10000000",
                "volume": "8913.30000000",
                "quoteVolume": "15.35733160",
                "openTime": 1565244579000,
                "closeTime": 1565244639000,
            ...
            [
                {
                    ...
                    "executedQty": "0",
                    "avgPrice": "0.00000",
                    "orderTime": 1564745217706,
                    "updateTime": 1564745217706
                }
            ]
    ...
    def futures_coin_open_interest_hist(self, **params):
        ...
        .. code-block:: python
            ...
            [
                {
                    "symbol": "BTCUSD_PERP",
                    "sumOpenInterest": "150000.00000000",
                    "sumOpenInterestValue": "150000.00000000",
                    "timestamp": 1564745791111
                },
                {
                    "symbol": "BTCUSD_PERP",
                    "sumOpenInterest": "150000.00000000",
            ...
            [
                {
                    ...
                    "brackets": [
                        ...
                        },
                        {
                            ...
                            "maintMarginRatio": "0.03000000",
                            "cum": "1000000.00000000"
                        },
                        {
                            "bracket": 7,
                            "initialLeverage": "20",
                            ...
                            "maintMarginRatio": "0.04000000",
                            "cum": "1500000.00000000"
                        },
                        {
                            "bracket": 8,
                            "initialLeverage": "15",
                            ...
                            "maintMarginRatio": "0.05000000",
                            "cum": "2250000.00000000"
                        },
                        {
                            "bracket": 9,
                            "initialLeverage": "10",
                            ...
                            "maintMarginRatio": "0.06250000",
                            "cum": "3375000.00000000"
                        },
                        {
                            "bracket": 10,
                            "initialLeverage": "5",
                            ...
                            "maintMarginRatio": "0.08000000",
                            "cum": "5000000.00000000"
                        }
                    ]
                }
            ]
    ...
    def new_transfer_history(self, **params):
        ...
        :type endTime: int
        :param current: optional, Current page
        :type current: int
        :param size: optional, Page size
        :type size: int
        :param recvWindow: optional, Recv window
        :type recvWindow: int
        :returns: API response
    ...
    def funding_wallet(self, **params):
        ...
        https://binance-docs.github.io/apidocs/spot/en/#get-funding-wallet-user_data

        :param asset: optional, Asset
        :type asset: str
        :param needBtcValuation: optional, Need BTC valuation
        :type needBtcValuation: bool
        :returns: API response

        .. code-block:: python

            {
                "totalFundingBalance": "0.00000000",
                "totalWithdrawAmount": "0.00000000",
    ...
    def get_user_asset(self, **params):
        ...
        https://binance-docs.github.io/apidocs/spot/en/#get-user-asset-user_data
    ...
    def universal_transfer(self, **params):
        ...
        :param type: required, Transfer type
        :type type: str
        :param asset: required, Asset
        :type asset: str
        :param amount: required, Amount
        :type amount: float
        :param fromSymbol: optional, From symbol
        :type fromSymbol: str
        :param toSymbol: optional, To symbol
        :type toSymbol: str
        :param recvWindow: optional, Recv window
        :type recvWindow: int
        :returns: API response
    ...
    def futures_coin_create_order(self, **params):
        ...
        :type type: str
        :param timeInForce: optional, Time in force
        :type timeInForce: str
        :param quantity: optional, Quantity
        :type quantity: float
        :param quoteOrderQty: optional, Quote order quantity
        :type quoteOrderQty: float
        :param price: optional, Price
        :type price: float
        :param newClientOrderId: optional, New client order id
        :type newClientOrderId: str
        :param stopPrice: optional, Stop price
        :type stopPrice: float
        :param closePosition: optional, Close position
        :type closePosition: bool
        :param activationPrice: optional, Activation price
        :type activationPrice: float
        :param callbackRate: optional, Callback rate
        :type callbackRate: float
        :param workingType: optional, Working type
        :type workingType: str
        :param priceProtect: optional, Price protect
        :type priceProtect: bool
        :param newOrderRespType: optional, New order response type
        :type newOrderRespType: str
        :param recvWindow: optional, Recv window
        :type recvWindow: int
        :returns: API response
    ...
    def futures_coin_place_batch_order(self, **params):
        ...
        :param batchOrders: required, Batch orders
        :type batchOrders: str
        :returns: API response
    ...
    def futures_coin_get_order(self, **params):
        ...
        :type orderId: int
        :param origClientOrderId: optional, Original client order id
        :type origClientOrderId: str
        :returns: API response
